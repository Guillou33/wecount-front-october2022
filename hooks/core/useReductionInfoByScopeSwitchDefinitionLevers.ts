...
function getReductionInfoForScopeSwitchDefinitionLevers(
    ...
    const reductionInfoInCategory = categoriesLevelDefinition !== undefined ? Object.entries(reductionInfoByCategory)
        .filter(
    ...
    const reductionInfoInActivityModel = categoriesLevelDefinition !== undefined ? Object.entries(reductionInfoByActivityModel)
        .filter(
...
const memoizedReductionInfoByScopeSwitchDefinitionLevers = memoize(getReductionInfoByScopeSwitchDefinitionLevers);
