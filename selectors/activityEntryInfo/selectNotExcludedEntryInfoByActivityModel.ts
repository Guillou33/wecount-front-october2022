...
const makeSelectNotExcludedEntryInfoByActivityModel = () => {
  const selectNotExcludedEntryInfoByActivityModel = createSelector(
    [
  ...
  return selectNotExcludedEntryInfoByActivityModel;
}

export default makeSelectNotExcludedEntryInfoByActivityModel();

export { makeSelectNotExcludedEntryInfoByActivityModel };
